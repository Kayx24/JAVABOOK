...
public class Admin {
    ...
    // private static void MenuNhanVien(Scanner sc, QuyenSach quyenSach, DanhSachTK danhSachTK, Sach[] danhSachSach,
    //         HoaDonItem[] hoaDonItems, DanhSachTK ds, NhanVien[] dsNhanViens) {
    ...
    public static void MenuQuanly(Sach[] danhSachSach, HoaDonItem[] hoaDonItems, DanhSachTK ds, NhanVien[] dNhanViens,
            String tenFile) {
        Scanner sc = new Scanner(System.in);
        int choice;
        QuyenSach quyenSach = new QuyenSach();
